...
describe('ConcurrencyRateLimiter (DeepSeek-style)', () => {
  ...
  it('fault: max retries → RATE_LIMIT_PAUSE', async () => {
  ...
  it('edge: DEEPSEEK defaults', () => {
    expect(DEEPSEEK_LIMITS.concurrency).toBe(500);
...
describe('createRateLimiter', () => {
  ...
  it('deepseek → concurrency limiter', () => {
    process.env.GIT_HELP_LLM_PROVIDER = 'deepseek';
    process.env.GIT_HELP_LLM_CONCURRENCY = '8';

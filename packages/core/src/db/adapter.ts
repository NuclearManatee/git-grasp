...
export const BrowserStubAdapter = {
  name: 'browser-stub',
  open() {
    throw new Error('BrowserStubAdapter.open is unavailable — use @git-grasp/core/browser');
  },
  knn() {
    throw new Error('BrowserStubAdapter.knn is unavailable — use @git-grasp/core/browser');
  },
  insert() {

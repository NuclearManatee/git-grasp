/**
 * One-shot: scrape `git help -a` → packages/core/taxonomy/git_commands.json
...
import { spawnGit } from '../packages/core/src/build/gitExec.ts';

const root = path.resolve(path.dirname(fileURLToPath(import.meta.url)), '..');
const outPath = path.join(root, 'packages', 'core', 'taxonomy', 'git_commands.json');
